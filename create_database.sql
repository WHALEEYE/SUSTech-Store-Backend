...
(
    ...
    trade_password    varchar(4),
    deal_code         smallint,
    refund_code       smallint,
...
comment on column second_hand_order.order_status is '1: Waiting for acknowledge; 2: Waiting for payment; 3: Trading; 4: Trade Success; 5: Refund Success; 6: Closed';
