...
//        try {
//            if (sendVCode("17764503596", "123456")) {
...
//    }
    ...
    private static SendStatus[] sendSMS(SMSTemplate SMSTemplate, String[] phoneNumberSet, String[] templateParamSet) throws TencentCloudSDKException {
        ...
        Credential cred = new Credential(System.getenv("TencentSecretId"), System.getenv("TencentSecretKey"));
        ...
        String sdkAppId = "1400577849";
        req.setSmsSdkAppId(sdkAppId);

        /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
        String signName = "面向对象个人网";
